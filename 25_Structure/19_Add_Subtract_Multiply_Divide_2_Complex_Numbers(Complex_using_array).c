//  Repeat   main  function   with   array  of  structures   Hint :  com   a[6];
...
{
	com a[6];
    a[0] = get(); // Reads  a   complex  number  to  structure  'a'
	a[1] = get();  // Reads  a   complex  number  to  structure  'b'
	a[2] = add(a[0] , a[1]); // c = a + b
	a[3] = sub(a[0] , a[1]); // d = a - b
	a[4] = mul(a[0] , a[1]); // e = a * b
	a[5]= div(a[0] , a[1]);// f  = a / b
	printf("Sum  :  ");
	disp(a[2]); // prints  contents  of  structure  'c'  in  the  form  of  complex  number
	printf("Difference :  ");
	disp(a[3]); // prints  contents  of  structure  'd'  in  the  form  of  complex  number
	printf("Product :  ");
	disp(a[4]); // prints  contents  of  structure  'e'  in  the  form  of  complex  number
	printf("Division  :  ");
	disp(a[5]); // prints  contents  of  structure  'f'  in  the  form  of  complex  number
}
