...
main()
{
	...
	printf("Difference :  ");
	disp(d); // prints  contents  of  structure  'd'  in  the  form  of  complex  number
	printf("Product :  ");
	disp(e); // prints  contents  of  structure  'e'  in  the  form  of  complex  number
	printf("Division  :  ");
	disp(f); // prints  contents  of  structure  'f'  in  the  form  of  complex  number
}
